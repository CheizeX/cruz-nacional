...
import { IContainerWassenger } from './WassengerSection.interface';

export const StyledAddWassenger = styled.div`
  width: 34.5rem;
  min-width: 608px;
  height: 35rem;
...
export const StyledHeaderWassenger = styled.div`
  height: 2.5rem;
  display: flex;
...
export const StyledBodyWassenger = styled.div<IContainerWassenger>`
  height: 27rem;
  display: flex;
  width: 100%;
  border-bottom: 1px solid ${({ theme }) => theme.Colors.grays[9]};
...
export const StyledFooterWassenger = styled.div`
  display: flex;
  height: 3.3rem;
