...
import { IPropsWassenger } from './WassengerSection.interface';
import {
  StyledAddWassenger,
  StyledBodyWassenger,
  StyledFooterWassenger,
  StyledHeaderWassenger,
} from './WassengerSection.styled';
...
export const WassengerSection: FC<IPropsWassenger> = ({
