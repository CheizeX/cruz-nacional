...
export const StyledDeleteChannel = styled.div`
  width: 360px;
  height: 280px;
...
export const StyledIconChannel = styled.div`
  width: 41px;
  height: 41px;
  margin: auto;
  & > div {
...
`;
export const StyledInformationChannel = styled.div`
  align-items: center;
  width: 318px;
  height: fit-content;
  margin: auto;
...
`;
export const StyledFooterChannel = styled.div`
  width: 360px;
  height: 55px;
  display: flex;
