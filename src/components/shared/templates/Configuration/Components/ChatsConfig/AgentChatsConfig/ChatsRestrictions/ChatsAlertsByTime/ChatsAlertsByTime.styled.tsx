...
export const StyledChatsAlertsByTime = styled.div`
...
export const StyledChatsAlertsByTimeHeader = styled.div`
  position: relative;
  width: 100%;
  height: 50px;
  display: flex;
...
export const StyledChatsAlertsByTimeBody = styled.div`
  min-width: 100%;
  min-height: 150px;
  height: fit-content;
  display: flex;
  ...
  & > div {
    ...
    & > div {
      ...
      & > :nth-child(3) {
        box-shadow: 0px 0px 5px 0px ${({ theme }) => theme.Colors.grays[5]};
        width: 60px;
        height: 30px;
        border-radius: 10%;
